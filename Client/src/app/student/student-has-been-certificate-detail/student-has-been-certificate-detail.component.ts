...
@Component({
  selector: 'app-student-has-been-certificate-detail',
  templateUrl: './student-has-been-certificate-detail.component.html',
  styleUrl: './student-has-been-certificate-detail.component.css'
})
export class StudentHasBeenCertificateDetailComponent implements OnInit {
  fileId!: string;
  id!: string;
