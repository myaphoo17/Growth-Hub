...
import { UploadFiles } from '../../models/student/StudentUploadFiles';
...
export class EnrollViewComponent implements OnInit {
  ...
  fetchCourses(): void {
    this.studentService.getEnrollCoursesview(this.staffId).subscribe(
      (data: CourseModelDTO[]) => {
        this.courses = data;
        this.loading = false;
        this.checkEnrollments();
