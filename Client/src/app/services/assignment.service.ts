...
export class AssignmentService {
  ...
  downloadAssignment(filename: string): Observable<Blob> {
  ...
  getStudentAssignmentsByAssignmentId(assignmentId: number): Observable<StudentAssignment[]> {
    return this.http.get<StudentAssignment[]>(`${this.baseUrl}/by-assignment/${assignmentId}/student-assignments`)
      .pipe(
        catchError(error => {
  ...
  // downloadFile(assignmentId: number): Observable<Blob> {
  //   return this.http.get(`${this.baseUrl}/download/${assignmentId}`, { responseType: 'blob' });
  // }
}
