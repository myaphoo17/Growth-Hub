...
import { EnrolledUserComponent } from './instructor/enrolled-user/enrolled-user.component';
import { StudentAllAssignmentComponent } from './student/student-all-assignment/student-all-assignment.component';
import { StudentHasBeenCertificateComponent } from './student/student-has-been-certificate/student-has-been-certificate.component';
import { StudentHasBeenCertificateDetailComponent } from './student/student-has-been-certificate-detail/student-has-been-certificate-detail.component';
...
const routes: Routes = [
  ...
  { path: "admin", component: AdminComponent, canActivate: [AdminGuard],
    ...
    { path: 'hasbeenCertificate', component: StudentHasBeenCertificateComponent},
    {path: 'hasbeenCertificateDetail/:courseId', component: StudentHasBeenCertificateDetailComponent},
      { path: 'profile-view/:staffId', component: ProfileViewComponent},
      { path: 'courses', component: CoursesComponent},
      { path: 'enrolled-user', component: EnrolledUserComponent},
  ...
  // Student Routes
  {
    ...
    children: [
      { path: 'stu-home/:categoryName', component: StudentHomeComponent},
      { path: 'profile-view/:staffId', component: ProfileViewComponent},
